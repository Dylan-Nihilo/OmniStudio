...
class TestModelSettingsIntegration:
    ...
    def test_series_has_default_model_settings(self):
        ...
        # defaults follow the priced catalog: video on Seedance 2.0, i2i unified
        # with t2i on gpt-image-2).
        assert s.model_settings.t2i_model == "gpt-image-2"
        assert s.model_settings.i2v_model == "seedance-2.0-i2v"
    ...
    def test_update_series_model_settings_via_pipeline(self, pipeline):
        ...
        assert updated.model_settings.i2i_model == "gpt-image-2"
    ...
    def test_update_series_model_settings_partial_via_copy(self, pipeline):
        ...
        assert updated.model_settings.i2i_model == "gpt-image-2"  # preserved
