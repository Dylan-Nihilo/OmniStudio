...
| Omni Studio 项目代码 | ✅ 极高 | ✅ 2026-07-03代码验证 |
...
| 工具 | 语言 | 核心能力 | FDX | 许可 | Omni Studio价值 |
|------|------|---------|-----|------|-----------|
...
| 协作 | CRDT实时 | 无 | 中 | P2 |
| 视觉生成 | 角色画像+分镜图 | 资产+分镜+**视频** | **Omni Studio领先** | 差异化 |
| 导出 | PDF/FDX/Fountain | 无 | **严重** | P1 |
| 视频管线 | 无 | 完整（→视频合成） | **Omni Studio核心优势** | — |
| API/集成 | 无API无自托管 | 完整REST API | **Omni Studio优势** | — |
...
| 剧本→视觉一体化 | 编剧→视频完整管线 | Omni Studio已领先，强化剧本驱动 |
...
4. Omni Studio「剧本→分镜→视频」是国产工具完全缺失的能力
5. 「微信聊天格式」说明非传统格式有真实需求

---

## 八、Omni Studio 当前剧本编辑器现状（代码验证 2026-07-03）
