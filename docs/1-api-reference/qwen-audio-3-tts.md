...
- Billing integration: Beijing pricing is ¥1.4 per 10,000 characters (¥0.14 per 1,000 characters), from the official model pricing page. The seed publishes it as `tts/qwen-audio-3.0-tts-plus`; an unpriced voice is rejected before contacting the provider when billing is enabled.
