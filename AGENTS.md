...
- GitHub repository: `Dylan-Nihilo/OmniStudio` (github remote). Open PRs with the currently authenticated maintainer account that has repository access; never hardcode or automatically switch to a specific collaborator account. See `.codex/workflows/omni-studio-git-publish.md` for the full flow
