                        ...
                        {isLoading ? (
                            ...
                            <>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <SelectField label={t("polishModelTitle")} className="[&>label]:sr-only" value={config.polish_model || "qwen3.7-plus"} onChange={value => setConfig(prev => ({ ...prev, polish_model: String(value) }))}
