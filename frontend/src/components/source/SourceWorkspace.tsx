        ...
        <main className={styles.detailPanel}>
          {!selectedSource ? <EmptyState title={t("selectSource")} description={t("selectSourceHint")} /> : <>
            ...
            {!selectedChapter && <>
              ...
              <SourceEpisodePanel linkedEpisodes={linkedEpisodes} availableEpisodes={availableEpisodes} busy={episodeBusy} loading={episodeLinksLoading} loadError={episodeLinksError} onRetry={() => { if (selectedSourceId) void loadEpisodeLinks(selectedSourceId); }} onLink={linkEpisode} onUnlink={unlinkEpisode} onOpenProduction={episodeId => { window.location.hash = `#/project/${episodeId}`; }} />
