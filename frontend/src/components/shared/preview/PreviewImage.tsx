                ...
                <>
                    ...
                    {!noLightbox && sizeBucket !== "micro" ? (
                        <button
                            ...
                            title={t("zoom")}
                            className={clsx(
                                "absolute right-1.5 top-1.5 grid h-7 w-7 place-items-center rounded-md border border-white/70 bg-white/90 text-black shadow-[0_1px_5px_rgba(0,0,0,0.45)] backdrop-blur transition-[opacity,transform,background-color] duration-fast ease-out-quart hover:scale-105 hover:bg-white focus-visible:outline-none focus-visible:opacity-100 focus-visible:ring-2 focus-visible:ring-primary/70",
                                alwaysShowMagnify
                                    ? "opacity-100"
